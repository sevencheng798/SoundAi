...
public:
	 ...
	 * 
	 * @params text The text that you want to convert.
	 * @params writer A writer of @c AttachmentWriter that TTS data will be write to.
	 ...
	 */
	virtual bool cancelTextToSpeech() = 0;
    /**
     * Destructor.
     */
