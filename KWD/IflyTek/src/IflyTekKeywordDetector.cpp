...
/// The Iflytek compatible AIUI sample rate of 16 kHz.
static const unsigned int IFLYTEK_COMPATIBLE_SAMPLE_RATE = 16000;
...
IflyTekKeywordDetector::IflyTekKeywordDetector(
	...
	std::chrono::milliseconds maxSamplesPerPush):
		...
		m_stream{stream},
		m_maxSamplesPerPush((IFLYTEK_COMPATIBLE_SAMPLE_RATE/HERTZ_PER_KILOHERTZ) * maxSamplesPerPush.count()){
}
