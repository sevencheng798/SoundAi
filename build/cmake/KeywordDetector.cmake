...
if(IFLYTEK_KEY_WORD_DETECTOR)
	...
	set(LIB_SHARED_BUFFER "${IFLYTEK_KEY_WORD_DETECTOR_LIB_PATH}/libSharedBuffer.a")
    set(KWD ON)
endif()
...
if(SOUNDAI_KEY_WORD_DETECTOR)
	...
	link_directories("${SOUNDAI_KEY_WORD_DETECTOR_LIB_PATH}")
	set(LIB_SHARED_BUFFER "${SOUNDAI_KEY_WORD_DETECTOR_LIB_PATH}/libsharedbuffer.a")
    set(KWD ON)
	set(GM_AEC ON)
	set(AEC_LIB_PATH ${CMAKE_SOURCE_DIR}/ThirdLibrary/EchoCancellation/lib)
	set(AEC_INCLUDE_DIR ${CMAKE_SOURCE_DIR}/ThirdLibrary/EchoCancellation/include)
