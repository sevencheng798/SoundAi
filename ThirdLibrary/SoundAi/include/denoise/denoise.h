 ...
 */
typedef void (*sai_denoise_data_handler_pt)(sai_denoise_ctx_t *ctx, const char *data, size_t size,
                                            void *user_data);
 ...
 * @param user_data User-defined data
 */
typedef void (*sai_denoise_event_handler_pt)(sai_denoise_ctx_t *ctx, int32_t code,
